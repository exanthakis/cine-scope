...
<template>
  <div class="text-black-primary dark:text-white-primary px-[5vw] md:px-[8vw] lg:px-[15vw]">
    ...
    <div v-else>
      ...
      <div
        class="max-2xl mx-auto grid grid-cols-1 gap-6 pb-7 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5"
      >
        <MovieCard
