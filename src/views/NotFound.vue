...
const { resource = 'page' } = defineProps<NotFoundProps>()
</script>

<template>
  <div class="text-black-primary dark:text-white-primary p-6 text-center">
    <h1
    ...
    <RouterLink class="text-xl font-bold" :to="{ name: 'movie-list' }">
