...
<template>
  <div class="w-full bg-[#181818] relative text-white">
    <div
      class="w-full bg-center bg-cover min-h-[70vh] bg-gradient-to-r from-gray-100 animate-pulse h-[80vh] px-[5vw] bg-gradient-bottom after:z-[-1] after:absolute after:content-[''] after:left-0 after:h-full after:w-full after:top-0"
    >
      <div
